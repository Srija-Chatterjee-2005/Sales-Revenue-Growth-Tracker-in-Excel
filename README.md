...
modCharts.bas – Updates charts automatically.

modDataAutomation.bas – Imports CSV and refreshes data.

modNavigation.bas – Navigates between worksheets.

modTheme.bas – Changes dashboard theme.

modUI.bas – Controls interface formatting.
